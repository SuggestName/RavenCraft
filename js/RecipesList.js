...
craftsManager.addRecipe(new Recipe("Set T1", {}, "Blacksmithing"));
...
craftsManager.addRecipe(new Recipe("Set T2", {}, "Blacksmithing"));
...
craftsManager.addRecipe(new Recipe("Set T3", {}, "Blacksmithing"));
...
craftsManager.addRecipe(new Recipe("Set T4", {}, "Blacksmithing"));
...
craftsManager.addRecipe(new Recipe("Carpentry Craft T1", {}, "Weaving"));
...
craftsManager.addRecipe(new Recipe("Carpentry Craft T2", {}, "Weaving"));
...
craftsManager.addRecipe(new Recipe("Cloth T1", {}, "Weaving"));
...
craftsManager.addRecipe(new Recipe("Cloth T2", {}, "Weaving"));
...
craftsManager.addRecipe(new Recipe("Cloth T3", {}, "Weaving"));
...
craftsManager.addRecipe(new Recipe("Cloth T4", {}, "Weaving"));
...
craftsManager.addRecipe(new Recipe("Leather T1", {}, "Weaving"));
...
craftsManager.addRecipe(new Recipe("Leather T2", {}, "Weaving"));
...
craftsManager.addRecipe(new Recipe("Leather T3", {}, "Weaving"));
...
craftsManager.addRecipe(new Recipe("Leather T4", {}, "Weaving"));
